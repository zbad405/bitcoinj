...
public class PaymentProtocol {
    ...
    public static final String MIMETYPE_PAYMENTREQUEST = "application/zetacoin-paymentrequest";
    public static final String MIMETYPE_PAYMENT = "application/zetacoin-payment";
    public static final String MIMETYPE_PAYMENTACK = "application/zetacoin-paymentack";
